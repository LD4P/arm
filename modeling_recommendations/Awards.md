...
In the traditional MARC environment, catalogers have recorded award information in the Awards note: 586. Access points related 
...
note style. The RDA registry provides a property rdau:P60090.
...
Wikidata (e.g. Sobey Art Award).
The VIVO ontology has a class vivo:Award and related properties, however those tend to have ranges limiting their use to 
foaf:Agent or foaf:Organization.
