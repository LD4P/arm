...
- Consider expanding CustodialHistory to include non-custodial events, such as rebinding, by changing CustodialHistory to the more general History. Considerations:
