...
ontology: e.g., https://w3id.org/arm/measurement/ontology/0.1/ for version 0.1.x.
...
prefix = 'https://w3id.org/arm/measurement/ontology/0.1/'
...
open('measurement.html','w').write(html)
