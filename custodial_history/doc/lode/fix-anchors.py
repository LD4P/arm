...
ontology: e.g., https://w3id.org/arm/custodial_history/ontology/0.1/ for version 0.1.x.
...
prefix = 'https://w3id.org/arm/custodial_history/ontology/0.1/'
...
open('custodial_history.html','w').write(html)
