...
vocabulary: e.g., https://w3id.org/arm/core/vocabulary/typeface/0.1/ for version 0.1.x.
...
prefix = 'https://w3id.org/arm/core/vocabulary/typeface/0.1/'
...
open('typeface.html','w').write(html)